...
snapshot_path = "./model/HAP/LA_{}_{}_labeled/{}".format(FLAGS.exp, FLAGS.labelnum, FLAGS.stage_name)
test_save_path = "./model/HAP/LA_{}_{}_labeled/{}_predictions/".format(FLAGS.exp, FLAGS.labelnum, FLAGS.model)
num_classes = 2
...
def testLA():
    ...
    model_path1 = os.path.join(f"./model/SDCL/LA_{FLAGS.exp}_{FLAGS.labelnum}_labeled/self_train", 'best_model_s_f.pth')
    # model_path2 = os.path.join(f"./model/SDCL/LA_{FLAGS.exp}_{FLAGS.labelnum}_labeled/self_train", 'best_model_v.pth')
    # model_path3 = os.path.join(f"./model/SDCL/LA_{FLAGS.exp}_{FLAGS.labelnum}_labeled/self_train", 'best_model_r.pth')
